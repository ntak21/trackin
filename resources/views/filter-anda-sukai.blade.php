    ...
    <div class = kolom2>
        <div class="kolom3">
            ...
            <h3 id="filter">Filter <i class='bx bxs-filter-alt'></i></h3>
                ...
                <button class="btn-active" onclick="filterSelection('anda-sukai')">Anda sukai</button>
                <button class="btn" onclick="filterSelection('rekomendasi')">Rekomendasi</button>
